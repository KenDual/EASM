...
const ICONS = {
    overview:
        '<path d="M3 12h7V3H3zM14 21h7V12h-7zM14 9h7V3h-7zM3 21h7v-6H3z"/>',
...
export function typeBadge(type) {
    ...
    if (t === "domain")
        return `<span class="badge badge-info">${icon("domain", { size: 10 })}domain</span>`;
    if (t === "ip")
        return `<span class="badge badge-accent">${icon("ip", { size: 10 })}ip</span>`;
