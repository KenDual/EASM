...
export async function renderJobs(container) {
  ...
  `;
    ...
    container
        .querySelector("#jobs-refresh")
        .addEventListener("click", () => load(true));
    container.querySelector("#jobs-q").addEventListener("input", (e) => {
        filter.q = e.target.value.trim();
        renderTable();
    });
    container.querySelector("#jobs-status").addEventListener("change", (e) => {
        filter.status = e.target.value;
        renderTable();
    });
    container.querySelector("#jobs-type").addEventListener("change", (e) => {
